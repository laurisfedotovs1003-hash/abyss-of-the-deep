...
function EconomyService:ProcessReceipt(player, receiptData)
    ...
    if receiptData.receiptType == "GamePass" then
        ...
        elseif receiptData.id == Config.GamePasses.VIPStatus then
                    ...
                    elseif receiptData.id == Config.GamePasses.AnomalyScanner then
                        if not data.PermanentUpgrades then data.PermanentUpgrades = {} end
                        data.PermanentUpgrades.AnomalyScanner = true

                    elseif receiptData.id == Config.GamePasses.AnomalyShield then
                        if not data.PermanentUpgrades then data.PermanentUpgrades = {} end
                        data.PermanentUpgrades.AnomalyShield = true
                    end
    ...
    elseif receiptData.receiptType == "DeveloperProduct" then
        local productMap = {
            ...
            [Config.DeveloperProducts.AnomalyPass] = { ResearchPoints = 15, inventory = { AnomalyBait = 5 } },
        }
